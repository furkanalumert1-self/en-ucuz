  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl border border-gray-100 p-8 max-w-sm w-full">
        ...
        <p className="text-sm text-gray-500 mb-6">en-ucuz.tr yönetim paneli</p>
        ...
        <form action={loginAction} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-orange-500 text-white font-semibold py-3 rounded-xl text-sm">
            Giriş Yap
          </button>
        </form>
      </div>
